...
var CallValidateFileService = /** @class */ (function () {
    function CallValidateFileService(fileToSlice) {
        this.fileToSlice = fileToSlice;
    }
    CallValidateFileService.prototype.runService = function () {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                pythonSliceMicroService = child_process_1.spawn(config_1["default"].PYTHON_INTERPRETER_PATH, [
                    config_1["default"].PYTHON_INPUT_TEST_SERVICE_PATH,
                    this.fileToSlice
                ]);
                outputMessage = {};
    ...
    return CallValidateFileService;
}());
exports["default"] = CallValidateFileService;
